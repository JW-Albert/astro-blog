...
ClawKit is open source (MIT). If you run OpenClaw — or you're curious how a stateless config generator is put together — take a look on **[GitHub](https://github.com/JW-Albert/ClawKit)**.
...
ClawKit 為開源專案（MIT 授權）。如果你正在使用 OpenClaw ── 或單純好奇一個無狀態的設定產生器是怎麼組起來的 ── 歡迎到 **[GitHub](https://github.com/JW-Albert/ClawKit)** 看看。
